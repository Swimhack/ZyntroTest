...
// Database save functions using ApiClient
async function saveContactSubmission(formData) {
    try {
        ...
        const result = await window.ApiClient.saveContactSubmission(sanitizedData);
...
async function saveSampleSubmission(formData) {
    try {
        ...
        const result = await window.ApiClient.saveSampleSubmission(sanitizedData);
...
async function saveNewsletterSubscription(email) {
    try {
        ...
        const result = await window.ApiClient.saveNewsletterSubscription(sanitizedEmail);
